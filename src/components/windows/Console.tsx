...
export const Console = () => {
  ...
  useEffect(() => {
    console.log(INTRO);
    console.log(
      "Wow you found the REAL console! Maybe you could use me too... (pause)",
    );
  }, []);

  return (
    <div
      className={`relative flex-1 overflow-y-auto overflow-x-hidden whitespace-break-spaces break-all bg-black-primary p-2 pb-[10%] text-sm text-white-primary [text-shadow:_0_0_1rem_#f5f9ff9c]`}
      ref={consoleRef}
      onPointerUp={(e) => {
        e.preventDefault();
        focusInput();
